...
public:
    ...
    static void WideTrace( trace_t* tr, gentity_t* ent, float32 range, float32 width, float32 height, gentity_t** target );
    ...
    static void meleeAttack( gentity_t* ent, float32 range, float32 width, float32 height, sint damage, meansOfDeath_t mod );
    static void bulletFire( gentity_t* ent, float32 spread, sint damage, sint mod );
    static void ShotgunPattern( vec3_t origin, vec3_t origin2, sint seed, gentity_t* ent );
