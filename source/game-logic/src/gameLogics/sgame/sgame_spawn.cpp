...
bool idSGameSpawn::SpawnString( pointer key, pointer defaultString, valueType** out )
{
    sint   i;
...
bool idSGameSpawn::SpawnFloat( pointer key, pointer defaultString, float32* out )
{
    valueType*    s;
    bool  present;
...
bool idSGameSpawn::SpawnInt( pointer key, pointer defaultString, sint* out )
{
    valueType*      s;
    bool  present;
...
bool idSGameSpawn::SpawnVector( pointer key, pointer defaultString, float32* out )
{
    valueType*    s;
    bool  present;
...
bool idSGameSpawn::SpawnVector4( pointer key, pointer defaultString, float32* out )
{
    valueType*    s;
    bool  present;
...
bool idSGameSpawn::ParseSpawnVars( void )
{
    ...
    if( com_token[0] != '{' )
    {
        idSGameMain::Error( "idSGameSpawn::ParseSpawnVars: found %s when expecting {", com_token );
    }
