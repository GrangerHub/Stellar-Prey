...
public:
    ...
    static void MatchOnePlayer( sint* plist, sint num, valueType* err, sint len );
    ...
    static void SayTo( gentity_t* ent, gentity_t* other, sint mode, sint color, pointer name, pointer message );
    static void Say( gentity_t* ent, gentity_t* target, sint mode, pointer chatText );
