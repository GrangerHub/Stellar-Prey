...
public:
    ...
    static bool TryPushingEntity(gentity_t *check, gentity_t *pusher,
                                 vec3_t move, vec3_t amove);
    static bool MoverPush(gentity_t *pusher, vec3_t move, vec3_t amove,
                          gentity_t **obstacle);
    static void MoverTeam(gentity_t *ent);
    static void SetMoverState(gentity_t *ent, moverState_t moverState,
                              sint time);
    ...
    static void Use_BinaryMover(gentity_t *ent, gentity_t *other,
                                gentity_t *activator);
    ...
    static void Start_Train(gentity_t *ent, gentity_t *other,
                            gentity_t *activator);
    static void Stop_Train(gentity_t *ent, gentity_t *other,
                           gentity_t *activator);
    static void Use_Train(gentity_t *ent, gentity_t *other,
                          gentity_t *activator);
    ...
    static void Touch_DoorTrigger(gentity_t *ent, gentity_t *other,
                                  trace_t *trace);
