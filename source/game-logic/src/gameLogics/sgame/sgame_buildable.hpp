...
public:
    ...
    static gentity_t* CheckSpawnPoint( sint spawnNum, vec3_t origin, vec3_t normal, buildable_t spawn, vec3_t spawnOrigin );
    ...
    static bool BuildableRange( vec3_t origin, float32 r, buildable_t buildable );
    static itemBuildError_t CanBuild( gentity_t* ent, buildable_t buildable, sint distance, vec3_t origin );
    ...
    static void nullDieFunction( gentity_t* self, gentity_t* inflictor, gentity_t* attacker, sint damage, sint mod );
    static void AGeneric_CreepRecede( gentity_t* self );
    static void AGeneric_Blast( gentity_t* self );
    static void AGeneric_Die( gentity_t* self, gentity_t* inflictor, gentity_t* attacker, sint damage, sint mod );
    static void AGeneric_CreepCheck( gentity_t* self );
    static void AGeneric_Think( gentity_t* self );
    static void AGeneric_Pain( gentity_t* self, gentity_t* attacker, sint damage );
    static void ASpawn_Die( gentity_t* self, gentity_t* inflictor, gentity_t* attacker, sint damage, sint mod );
    static void ASpawn_Think( gentity_t* self );
    static void AOvermind_Think( gentity_t* self );
    static void ABarricade_Pain( gentity_t* self, gentity_t* attacker, sint damage );
    static void ABarricade_Shrink( gentity_t* self, bool shrink );
    static void ABarricade_Die( gentity_t* self, gentity_t* inflictor, gentity_t* attacker, sint damage, sint mod );
    ...
    static void AHive_Die( gentity_t* self, gentity_t* inflictor, gentity_t* attacker, sint damage, sint mod );
    ...
    static void AHovel_Die( gentity_t* self, gentity_t* inflictor, gentity_t* attacker, sint damage, sint mod );
    static void ABooster_Touch( gentity_t* self, gentity_t* other, trace_t* trace );
    static void ATrapper_FireOnEnemy( gentity_t* self, sint firespeed, float32 range );
    static bool ATrapper_CheckTarget( gentity_t* self, gentity_t* target, sint range );
    ...
    static void HMedistat_Die( gentity_t* self, gentity_t* inflictor, gentity_t* attacker, sint damage, sint mod );
    ...
    static void HSpawn_Die( gentity_t* self, gentity_t* inflictor, gentity_t* attacker, sint damage, sint mod );
