...
public:
    ...
    static void AddRemap( pointer oldShader, pointer newShader, float32 timeOffset );
    ...
    static sint FindConfigstringIndex( valueType* name, sint start, sint max, bool create );
    ...
    static void AddPredictableEvent( gentity_t* ent, sint _event, sint eventParm );
    ...
    static gentity_t* ClosestEnt( vec3_t origin, gentity_t** entities, sint numEntities );
