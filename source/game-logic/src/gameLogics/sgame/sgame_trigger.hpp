...
public:
    ...
    static void Use_Multi(gentity_t *ent, gentity_t *other,
                          gentity_t *activator);
    ...
    static void trigger_push_touch(gentity_t *self, gentity_t *other,
                                   trace_t *trace);
    static void AimAtTarget(gentity_t *self);
    static void SP_trigger_push(gentity_t *self);
    static void Use_target_push(gentity_t *self, gentity_t *other,
                                gentity_t *activator);
    static void SP_target_push(gentity_t *self);
    static void trigger_teleporter_use(gentity_t *ent, gentity_t *other,
                                       gentity_t *activator);
    static void SP_trigger_teleport(gentity_t *self);
    static void hurt_use(gentity_t *self, gentity_t *other,
                         gentity_t *activator);
    ...
    static void func_timer_use(gentity_t *self, gentity_t *other,
                               gentity_t *activator);
    static void SP_func_timer(gentity_t *self);
    static void trigger_stage_use(gentity_t *self, gentity_t *other,
                                  gentity_t *activator);
    static void SP_trigger_stage(gentity_t *self);
    static void trigger_win(gentity_t *self, gentity_t *other,
                            gentity_t *activator);
    static void SP_trigger_win(gentity_t *self);
    static bool trigger_buildable_match(gentity_t *self, gentity_t *activator);
    static void trigger_buildable_trigger(gentity_t *self,
                                          gentity_t *activator);
    static void trigger_buildable_touch(gentity_t *ent, gentity_t *other,
                                        trace_t *trace);
    static void trigger_buildable_use(gentity_t *ent, gentity_t *other,
                                      gentity_t *activator);
    ...
    static void trigger_class_touch(gentity_t *ent, gentity_t *other,
                                    trace_t *trace);
    static void trigger_class_use(gentity_t *ent, gentity_t *other,
                                  gentity_t *activator);
    static void SP_trigger_class(gentity_t *self);
    static bool trigger_equipment_match(gentity_t *self, gentity_t *activator);
    static void trigger_equipment_trigger(gentity_t *self,
                                          gentity_t *activator);
    static void trigger_equipment_touch(gentity_t *ent, gentity_t *other,
                                        trace_t *trace);
    static void trigger_equipment_use(gentity_t *ent, gentity_t *other,
                                      gentity_t *activator);
    static void SP_trigger_equipment(gentity_t *self);
    static void trigger_gravity_touch(gentity_t *ent, gentity_t *other,
                                      trace_t *trace);
    static void trigger_gravity_use(gentity_t *ent, gentity_t *other,
                                    gentity_t *activator);
    static void SP_trigger_gravity(gentity_t *self);
    static void trigger_heal_use(gentity_t *self, gentity_t *other,
                                 gentity_t *activator);
    static void trigger_heal_touch(gentity_t *self, gentity_t *other,
                                   trace_t *trace);
    static void SP_trigger_heal(gentity_t *self);
    static void trigger_ammo_touch(gentity_t *self, gentity_t *other,
                                   trace_t *trace);
