...
public:
    ...
    static bool RegisterClientSkin( clientInfo_t* ci, pointer modelName, pointer skinName );
    static bool RegisterClientModelname( clientInfo_t* ci, pointer modelName, pointer skinName );
    ...
    static void PrecacheClientInfo( class_t _class, valueType* model, valueType* skin );
    static void TeamJoinMessage( clientInfo_t* newInfo, clientInfo_t* ci );
    static void NewClientInfo( sint clientNum );
    static void SetLerpFrameAnimation( clientInfo_t* ci, lerpFrame_t* lf, sint newAnimation );
    static void RunPlayerLerpFrame( clientInfo_t* ci, lerpFrame_t* lf, sint newAnimation, float32 speedScale );
    static void ClearLerpFrame( clientInfo_t* ci, lerpFrame_t* lf, sint animationNumber );
    static void PlayerAnimation( centity_t* cent, sint* legsOld, sint* legs, float32* legsBackLerp, sint* torsoOld, sint* torso, float32* torsoBackLerp );
    static void PlayerNonSegAnimation( centity_t* cent, sint* nonSegOld, sint* nonSeg, float32* nonSegBackLerp );
    static void SwingAngles( float32 destination, float32 swingTolerance, float32 clampTolerance, float32 speed, float32* angle, bool* swinging );
    ...
    static bool PlayerShadow( centity_t* cent, float32* shadowPlane, class_t _class );
