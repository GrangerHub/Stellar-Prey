...
{
    Printf( "(%i %i %i) : %i\n", ( sint )cg.refdef.vieworg[ 0 ], ( sint )cg.refdef.vieworg[ 1 ], ( sint )cg.refdef.vieworg[ 2 ], ( sint )cg.refdefViewAngles[ YAW ] );
}
...
void idCGameConsoleCmds::SquadMark_f( void )
{
    ...
    idCGamePredict::Trace( &trace, cg.refdef.vieworg, nullptr, nullptr, end, cg.snap->ps.clientNum, CONTENTS_SOLID | CONTENTS_BODY );
