...
void idCGameMain::SetPVars(void) {
    ...
    if(cgameLocal.CrosshairPlayer() != -1) {
        trap_Cvar_Set("p_crosshairrname",
                      cgs.clientinfo[cgameLocal.CrosshairPlayer()].name);
    }
}
...
void idCGameMain::RegisterSounds(void) {
    ...
    cgs.media.alienStageTransition =
        trap_S_RegisterSound("sound/announcements/overmindevolved.ogg");
    cgs.media.humanStageTransition =
        trap_S_RegisterSound("sound/announcements/reinforcement.ogg");

    cgs.media.alienOvermindAttack =
        trap_S_RegisterSound("sound/announcements/overmindattack.ogg");
    cgs.media.alienOvermindDying =
        trap_S_RegisterSound("sound/announcements/overminddying.ogg");
    cgs.media.alienOvermindSpawns =
        trap_S_RegisterSound("sound/announcements/overmindspawns.ogg");

    cgs.media.alienL1Grab =
        trap_S_RegisterSound("sound/player/level1/grab.ogg");
    cgs.media.alienL4ChargePrepare =
        trap_S_RegisterSound("sound/player/level4/charge_prepare.ogg");
    cgs.media.alienL4ChargeStart =
        trap_S_RegisterSound("sound/player/level4/charge_start.ogg");
    ...
    cgs.media.turretSpinupSound =
        trap_S_RegisterSound("sound/buildables/mgturret/spinup.ogg");
    cgs.media.weaponEmptyClick =
        trap_S_RegisterSound("sound/weapons/click.ogg");

    cgs.media.talkSound = trap_S_RegisterSound("sound/misc/talk.ogg");
    cgs.media.alienTalkSound =
        trap_S_RegisterSound("sound/misc/alien_talk.ogg");
    cgs.media.humanTalkSound =
        trap_S_RegisterSound("sound/misc/human_talk.ogg");
    ...
    cgs.media.jetpackDescendSound =
        trap_S_RegisterSound("sound/upgrades/jetpack/low.ogg");
    cgs.media.jetpackIdleSound =
        trap_S_RegisterSound("sound/upgrades/jetpack/idle.ogg");
    cgs.media.jetpackAscendSound =
        trap_S_RegisterSound("sound/upgrades/jetpack/hi.ogg");

    cgs.media.medkitUseSound =
        trap_S_RegisterSound("sound/upgrades/medkit/medkit.ogg");

    cgs.media.alienEvolveSound =
        trap_S_RegisterSound("sound/player/alienevolve.ogg");

    cgs.media.alienBuildableExplosion =
        trap_S_RegisterSound("sound/buildables/alien/explosion.ogg");
    cgs.media.alienBuildableDamage =
        trap_S_RegisterSound("sound/buildables/alien/damage.ogg");
    cgs.media.alienBuildablePrebuild =
        trap_S_RegisterSound("sound/buildables/alien/prebuild.ogg");

    cgs.media.humanBuildableExplosion =
        trap_S_RegisterSound("sound/buildables/human/explosion.ogg");
    cgs.media.humanBuildablePrebuild =
        trap_S_RegisterSound("sound/buildables/human/prebuild.ogg");
    ...
    cgs.media.hardBounceSound1 =
        trap_S_RegisterSound("sound/misc/hard_bounce1.ogg");
    cgs.media.hardBounceSound2 =
        trap_S_RegisterSound("sound/misc/hard_bounce2.ogg");

    cgs.media.repeaterUseSound =
        trap_S_RegisterSound("sound/buildables/repeater/use.ogg");

    cgs.media.buildableRepairSound =
        trap_S_RegisterSound("sound/buildables/human/repair.ogg");
    cgs.media.buildableRepairedSound =
        trap_S_RegisterSound("sound/buildables/human/repaired.ogg");

    cgs.media.lCannonWarningSound =
        trap_S_RegisterSound("models/weapons/lcannon/warning.ogg");
    cgs.media.lCannonWarningSound2 =
        trap_S_RegisterSound("models/weapons/lcannon/warning2.ogg");
}
...
void idCGameMain::RegisterGraphics(void) {
    ...
    for(i = 0; i < 8; i++) {
        cgs.media.buildWeaponTimerPie[i] = trap_R_RegisterShader(
                                               buildWeaponTimerPieShaders[i]);
    }

    for(i = 0; i < 11; i++) {
        cgs.media.alienAttackFeedbackShaders[i] = trap_R_RegisterShader(
                    alienAttackFeedbackShaders[i]);
    }

    for(i = 0; i < 11; i++) {
        cgs.media.alienAttackFeedbackShadersFlipped[i] = trap_R_RegisterShader(
                    alienAttackFeedbackShadersFlipped[i]);
    }

    for(i = 0; i < 11; i++) {
        cgs.media.alienRangedAttackFeedbackShaders[i] = trap_R_RegisterShader(
                    alienRangedAttackFeedbackShaders[i]);
    }

    // player health cross shaders
    cgs.media.healthCross =
        trap_R_RegisterShader("gui/assets/neutral/cross.tga");
    cgs.media.healthCross2X =
        trap_R_RegisterShader("gui/assets/neutral/cross2.tga");
    cgs.media.healthCross3X =
        trap_R_RegisterShader("gui/assets/neutral/cross3.tga");
    cgs.media.healthCrossMedkit =
        trap_R_RegisterShader("gui/assets/neutral/cross_medkit.tga");
    cgs.media.healthCrossPoisoned =
        trap_R_RegisterShader("gui/assets/neutral/cross_poison.tga");

    // squad markers
    cgs.media.squadMarkerH =
        trap_R_RegisterShader("gui/assets/neutral/squad_h");
    cgs.media.squadMarkerV =
        trap_R_RegisterShader("gui/assets/neutral/squad_v");
    ...
    cgs.media.disconnectPS =
        idCGameParticles::RegisterParticleSystem("disconnectPS");
    ...
    cgs.media.poisonCloudPS =
        idCGameParticles::RegisterParticleSystem("firstPersonPoisonCloudPS");
    cgs.media.poisonCloudedPS =
        idCGameParticles::RegisterParticleSystem("poisonCloudedPS");
    cgs.media.alienEvolvePS =
        idCGameParticles::RegisterParticleSystem("alienEvolvePS");
    cgs.media.alienAcidTubePS =
        idCGameParticles::RegisterParticleSystem("alienAcidTubePS");

    cgs.media.jetPackDescendPS =
        idCGameParticles::RegisterParticleSystem("jetPackDescendPS");
    cgs.media.jetPackHoverPS =
        idCGameParticles::RegisterParticleSystem("jetPackHoverPS");
    cgs.media.jetPackAscendPS =
        idCGameParticles::RegisterParticleSystem("jetPackAscendPS");

    cgs.media.humanBuildableDamagedPS =
        idCGameParticles::RegisterParticleSystem("humanBuildableDamagedPS");
    cgs.media.alienBuildableDamagedPS =
        idCGameParticles::RegisterParticleSystem("alienBuildableDamagedPS");
    cgs.media.humanBuildableHitSmallPS =
        idCGameParticles::RegisterParticleSystem("humanBuildableHitSmallPS");
    cgs.media.alienBuildableHitSmallPS =
        idCGameParticles::RegisterParticleSystem("alienBuildableHitSmallPS");
    cgs.media.humanBuildableHitLargePS =
        idCGameParticles::RegisterParticleSystem("humanBuildableHitLargePS");
    cgs.media.alienBuildableHitLargePS =
        idCGameParticles::RegisterParticleSystem("alienBuildableHitLargePS");
    cgs.media.humanBuildableDestroyedPS =
        idCGameParticles::RegisterParticleSystem("humanBuildableDestroyedPS");
    cgs.media.alienBuildableDestroyedPS =
        idCGameParticles::RegisterParticleSystem("alienBuildableDestroyedPS");

    cgs.media.alienBleedPS =
        idCGameParticles::RegisterParticleSystem("alienBleedPS");
    cgs.media.humanBleedPS =
        idCGameParticles::RegisterParticleSystem("humanBleedPS");

    idCGameBuildable::BuildableStatusParse("gui/assets/human/buildstat.cfg",
                                           &cgs.humanBuildStat);
    idCGameBuildable::BuildableStatusParse("gui/assets/alien/buildstat.cfg",
                                           &cgs.alienBuildStat);
    ...
    for(i = 1; i < MAX_GAME_PARTICLE_SYSTEMS; i++) {
        ...
        cgs.gameParticleSystems[ i ] = idCGameParticles::RegisterParticleSystem((
                                           valueType *)psName);
    }
}
...
void idCGameMain::RegisterClients(void) {
    ...
    for(i = PCL_NONE + 1; i < PCL_NUM_CLASSES;  i++) {
        idCGamePlayers::PrecacheClientInfo((class_t)i,
                                           bggame->ClassConfig((class_t)i)->modelName,
                                           bggame->ClassConfig((class_t)i)->skinName);
...
===============
*/
bool idCGameMain::OwnerDrawHandleKey(sint ownerDraw, sint flags,
...
===============
*/
clientInfo_t *idCGameMain::InfoFromScoreIndex(sint index, sint team,
        sint *scoreIndex) {
    sint i, count;
    count = 0;
...
===============
*/
pointer idCGameMain::FeederItemText(float32 feederID, sint index,
                                    sint column, qhandle_t *handle) {
    sint scoreIndex = 0;
...
void idCGameMain::FeederSelection(float32 feederID, sint index) {
    sint i, count;
    sint team = (feederID == FEEDER_ALIENTEAM_LIST) ? TEAM_ALIENS :
                TEAM_HUMANS;
    count = 0;
...
===============
*/
void idCGameMain::Text_PaintWithCursor(float32 x, float32 y, float32 scale,
...
===============
*/
sint idCGameMain::PlayCinematic(pointer name, float32 x, float32 y,
                                float32 w, float32 h) {
...
===============
*/
void idCGameMain::DrawCinematic(sint handle, float32 x, float32 y,
                                float32 w, float32 h) {
...
=================
*/
void idCGameLocal::Init(sint serverMessageNum, sint serverCommandSequence,
                        sint clientNum, bool demoPlayback) {
    pointer  s;
